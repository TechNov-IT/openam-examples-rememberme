 ...
 * is present, additional checks are performed in order to verify the user's identity.
 * In order to leverage the remember me feature, you need to modify the organization authentication chain to include
 * the remember me module with SUFFICIENT criteria.
 *
 * @author Peter Major
 */
public class RememberMe extends AMLoginModule {
     ...
     * expected to have the format of: username%realm%timestamp
     * Once the cookie is validated the module may return LOGIN_IGNORE (advances to next module), or LOGIN_SUCCEED.
